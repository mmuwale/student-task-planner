...
<head>
    ...
    <title>Edit Course - Student Task Planner</title>
    <style>
        * {
            margin: 0;
            padding: 0;
            ...
            <div class="card">
                <form action="{{ route('courses.update', $course) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="credits" name="credits" value="{{ old('credits', $course->credits) }}" min="1" max="10" required>
                        @error('credits')
                            <div class="error-message">{{ $message }}</div>
                        @enderror
                    </div>
